...
namespace Acrossoft.Go.Screens
{
    public class BoardScreen : Screen
    {
        ...
        public override void Initialize()
        {
            ...
            m_downFunction.AssignButton(Buttons.LeftThumbstickDown);
            ...
            m_upFunction.AssignButton(Buttons.LeftThumbstickUp);
            ...
            m_leftFunction.AssignButton(Buttons.LeftThumbstickLeft);
            ...
            m_rightFunction.AssignButton(Buttons.LeftThumbstickRight);
